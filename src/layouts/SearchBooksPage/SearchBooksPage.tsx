...
export const SearchBooksPage = () => {
  // TODO: Add category table to the back end and remove category boilerplate code
        ...
        <div>
          ...
          {totalAmountOfBooks > 0 ? (
            ...
            <div className="m-5">
              ...
              <a
                type="button"
                className="btn bg-primary btn-md px-4 me-md-2 fw-bold text-white"
                href="#"
              >
                Library Services
              </a>
